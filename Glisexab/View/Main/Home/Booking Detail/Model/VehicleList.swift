...
struct Res_VehicleList: Codable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey {
        case vehicleId = "id"
        case vehicle, image, status, no_of_bag, date_time, base_fair, per_hour, per_minute,
             ...
             web_Stop_Price = "Web_Stop_Price", safety_fee, airport_fee, distance,
             estimate_fair, estimate_time, vehicle_added
    }
